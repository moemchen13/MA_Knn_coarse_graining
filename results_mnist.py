...
slrw_hbn  = create_graph(X=X,y=y,sampling=sampling_hbn,connection=connection_slrw,filename="slrw-hbn.pkl",dir=dir)
...
metrics_slrw_hbn_1 =   get_metrics_if_exist("slrw_hbn_metrics_1",   [get_spectral_graph_metrics,get_graph_metrics,get_embedding_metrics],dir=dir,graph=slrw_hbn.bigger_graph,closeness_knn=closeness_knn_undirected,betweenness_knn=betweenness_knn_undirected,eigenvalues_big=eigenvalues_big_undirected,X=X,y=y)
metrics_slrw_hbn_2 =   get_metrics_if_exist("slrw_hbn_metrics_2",   [get_spectral_graph_metrics,get_graph_metrics,get_embedding_metrics],dir=dir,graph=slrw_hbn,closeness_knn=closeness_knn_undirected,betweenness_knn=betweenness_knn_undirected,eigenvalues_big=eigenvalues_big_undirected,X=X,y=y)
...
metrics_directed_slrw_hbn_1 =   get_metrics_if_exist("directed_slrw_hbn_metrics_1",   [get_graph_metrics,get_embedding_metrics],dir=dir,graph=directed_slrw_hbn.bigger_graph,closeness_knn=closeness_knn_directed,betweenness_knn=betweenness_knn_directed,eigenvalues_big=eigenvalues_big_undirected,X=X,y=y,directed=True)
metrics_directed_slrw_hbn_2 =   get_metrics_if_exist("directed_slrw_hbn_metrics_2",   [get_graph_metrics,get_embedding_metrics],dir=dir,graph=directed_slrw_hbn,closeness_knn=closeness_knn_directed,betweenness_knn=betweenness_knn_directed,eigenvalues_big=eigenvalues_big_undirected,X=X,y=y,directed=True)


# %%
#lower leve
landmarks = [directed_slrw_rw.bigger_graph.find_corresponding_landmarks_at_level(),slrw_rw.bigger_graph.find_corresponding_landmarks_at_level(),directed_slrw_hubs.bigger_graph.find_corresponding_landmarks_at_level(),slrw_hubs.bigger_graph.find_corresponding_landmarks_at_level()]
kind_labels = ["RW","Hubs"]
...
# %%
embeddings = [
    [((directed_slrw_hubs.bigger_graph.TSNE,directed_slrw_hubs.bigger_graph.find_corresponding_landmarks_at_level())),((directed_slrw_rw.bigger_graph.TSNE,directed_slrw_rw.bigger_graph.find_corresponding_landmarks_at_level())),((directed_slrw_hbn.bigger_graph.TSNE,directed_slrw_hbn.bigger_graph.find_corresponding_landmarks_at_level())),((directed_slrw_random.bigger_graph.TSNE,directed_slrw_random.bigger_graph.find_corresponding_landmarks_at_level()))],
    [((slrw_hubs.bigger_graph.TSNE,slrw_hubs.bigger_graph.find_corresponding_landmarks_at_level())),((slrw_rw.bigger_graph.TSNE,slrw_rw.bigger_graph.find_corresponding_landmarks_at_level())),((slrw_hbn.bigger_graph.TSNE,slrw_hbn.bigger_graph.find_corresponding_landmarks_at_level())),((slrw_random.bigger_graph.TSNE,slrw_random.bigger_graph.find_corresponding_landmarks_at_level()))]
]
names=["Hubs","RW","HBN","Random"]
titles=["directed","undirected"]
plg.plot_embeddings_mosaic_discrete(embeddings,titles=titles,names=names,y=y,colors=colors,fsave=f"{data_name}_directed_undirected_over_levels")
...
connectivity = OOP_Connecting.Connectivity(seed=seed)
label_propagation_udir = create_graph(sampling=random_sampling,connection=connectivity,X=X,y=y,filename="lp-random",dir=dir,level=2,seed=seed,directed=False,discrete=True)
label_propagation_dir = create_graph(sampling=random_sampling,connection=connectivity,X=X,y=y,filename="lp-random_dir",dir=dir,level=2,seed=seed,directed=True,discrete=True)
